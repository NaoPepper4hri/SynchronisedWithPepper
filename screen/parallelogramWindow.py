...
class parallelogramCanvas(shapeWindow):
    def __init__(self, robotShape, target):
        super(self.__class__, self).__init__("Parallelogram", target)
    ...
    def initUI(self, robotShape):
        ...
        self.increment = 4
        self.slope =  1
        self.baseLength = windowLength/2 + 20 
        self.height = windowHeight/4 + 20
        
        self.xmin = (windowLength - self.baseLength - self.height)/2
        self.xmax = (windowLength + self.baseLength + self.height)/2
